...
package com.kelvin.jom.persistence.helpers;
...
public interface Inspector {
    ...
    Query getNamedQuery(String named, DefineQueryType type);
    ...
    Map<Column, Object> getFields();

    Inspector update(Object target);
}
