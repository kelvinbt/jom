...
public class ProcedureQueryBuilder<T> extends AbstractEntityQueryBuilder<T> {
    public ProcedureQueryBuilder(T entity) {
        super(entity);
    }

    @Override
    protected String build() {
        throw new NotImplementedMethodException("invalid call!");
    }

    public String procedure(String name) {
        return super.getNamedQueryByType(name, DefineQueryType.PROCEDURE);
    }
